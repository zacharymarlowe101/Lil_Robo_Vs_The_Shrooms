...
public class LoseScreen extends Screen {
    ...
    public void initialize() {
        //System.out.println("In Lose Screen Initialize");
        instructions = new SpriteFont("You Died, Press Space To Restart", 175, 239, "Arial", 30, Color.white);
    ...
    public void update() {
        ...
        //System.out.println("In Lose Screen Update");
    ...
    public void draw(GraphicsHandler graphicsHandler) {
       //System.out.println("In Lose Screen Draw");
